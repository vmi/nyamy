# 109.mayu.rb -- Ruby (mruby) version of 109.mayu
# Auto-converted from 109.mayu following doc/scripter-design/mruby-binding.md.
# 109 Japanese keyboard definition.
...
defkey "CircumflexAccent", "Caret",     scan: "0x0d"
...
defkey "O",                             scan: "0x18"
defkey "P",                             scan: "0x19"
defkey "CommercialAt", "Atmark",        scan: "0x1a"
defkey "LeftSquareBracket", "OpenBracket", scan: "0x1b"
...
defkey "Colon",                         scan: "0x28"
defkey "半角/全角", "漢字", "Kanji",     scan: "0x29"
defkey "E0半角/全角", "E0漢字", "E0Kanji", scan: "E0-0x29"
defkey "LeftShift", "LShift",           scan: "0x2a"
defkey "RightSquareBracket", "CloseBracket", scan: "0x2b"
defkey "Z",                             scan: "0x2c"
defkey "X",                             scan: "0x2d"
defkey "C",                             scan: "0x2e"
defkey "V",                             scan: "0x2f"
...
defkey "英数", "Eisuu",                 scan: "0x3a"
defkey "E0英数", "E0Eisuu",             scan: "E0-0x3a"
defkey "F1",                            scan: "0x3b"
defkey "F2",                            scan: "0x3c"
defkey "F3",                            scan: "0x3d"
defkey "F4",                            scan: "0x3e"
...
defkey "ひらがな", "Hiragana",          scan: "0x70"
defkey "E0ひらがな", "E0Hiragana",      scan: "E0-0x70"
defkey "ReverseSolidus", "BackSlash",   scan: "0x73"
defkey "変換", "Convert",               scan: "0x79"
defkey "無変換", "NonConvert",          scan: "0x7b"
defkey "E0無変換", "E0NonConvert",      scan: "E0-0x7b"
defkey "YenSign", "Yen",                scan: "0x7d"
defkey "MM/Messanger",                  scan: "E0-0x05"
defkey "MM/Undo", "MM/F2",              scan: "E0-0x08"
defkey "MM/Redo", "MM/F3",              scan: "E0-0x07"
defkey "MediaPrevTrack", "ScanPreviousTrack", "PreviousTrack", scan: "E0-0x10"
defkey "VAIO/TV/VIDEO",                 scan: "E0-0x11"
defkey "VAIO/TIMER-REC",                scan: "E0-0x12"
defkey "VAIO/DV-CAPTURE",               scan: "E0-0x13"
defkey "VAIO/VIDEO-EDIT",               scan: "E0-0x14"
defkey "VAIO/MAIL",                     scan: "E0-0x15"
defkey "VAIO/INTERNET",                 scan: "E0-0x16"
defkey "MediaNextTrack", "ScanNextTrack", "NextTrack", scan: "E0-0x19"
defkey "NumEnter", "NumReturn",         scan: "E0-0x1c"
defkey "RightControl", "RControl", "RCtrl", scan: "E0-0x1d"
defkey "VolumeMute", "Mute",            scan: "E0-0x20"
defkey "MM/Calculator", "ALCalculator", scan: "E0-0x21"
defkey "MediaPlayPause", "Play/Pause",  scan: "E0-0x22"
defkey "MM/SpellCheck", "MM/F10",       scan: "E0-0x23"
defkey "MediaStop", "Stop",             scan: "E0-0x24"
defkey "VolumeDown", "VolumeDecrement", scan: "E0-0x2e"
defkey "VolumeUp", "VolumeIncrement",   scan: "E0-0x30"
defkey "BrowserHome", "ACHome", "Internet", scan: "E0-0x32"
defkey "NumSolidus", "NumSlash",        scan: "E0-0x35"
defkey "PrintScreen", "Snapshot",       scan: "E0-0x37"
defkey "RightAlt", "RAlt", "RMenu",     scan: "E0-0x38"
defkey "MM/Help", "MM/F1",              scan: "E0-0x3b"
defkey "MM/MyMusic",                    scan: "E0-0x3c"
defkey "MM/New", "MM/F4",               scan: "E0-0x3e"
defkey "MM/Open", "MM/F5",              scan: "E0-0x3f"
defkey "MM/Close", "MM/F6",             scan: "E0-0x40"
defkey "MM/Reply", "MM/F7",             scan: "E0-0x41"
defkey "MM/Forward", "MM/F8",           scan: "E0-0x42"
defkey "MM/Send", "MM/F9",              scan: "E0-0x43"
...
defkey "MM/MyDocument",                 scan: "E0-0x4c"
...
defkey "MM/Save", "MM/F11",             scan: "E0-0x57"
defkey "MM/Print", "MM/F12",            scan: "E0-0x58"
...
defkey "MM/MyPicture",                  scan: "E0-0x64"
defkey "BrowserSearch", "ACSearch",     scan: "E0-0x65"
defkey "BrowserFavorites", "ACBookmarks", scan: "E0-0x66"
defkey "BrowserRefresh", "ACRefresh",   scan: "E0-0x67"
defkey "BrowserStop", "ACStop",         scan: "E0-0x68"
defkey "BrowserForward", "ACForward",   scan: "E0-0x69"
defkey "BrowserBack", "ACBack",         scan: "E0-0x6a"
defkey "ALLocalBrowser",                scan: "E0-0x6b"
defkey "LaunchMail", "ALEmailReader", "Email", scan: "E0-0x6c"
